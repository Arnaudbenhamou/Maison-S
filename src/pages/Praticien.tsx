            ...
            >
              <div className="flex flex-col items-center mb-6">
                ...
                <div className="flex items-center mb-2">
                  ...
                  />
              {/* Diplômes d'Arnaud */}
              <div className="text-left space-y-4 text-sealiah-amber text-sm">
                <h4 className="text-lg font-serif text-sealiah-eucalyptus mb-3">Diplômes nationaux et universitaires</h4>
                <div className="space-y-3">
                  <div>
                    <p className="font-semibold">2022</p>
                    <p>Diplôme d'Ostéopathe (D.O.) - Collège Ostéopathique du Pays Basque (COPB)</p>
                  </div>
                  <div>
                    <p className="font-semibold">2015</p>
                    <p>MKDE - Diplôme d'État de Masseur-Kinésithérapeute - Université Alfonso X el Sabio (UAX) - Madrid</p>
                  </div>
                </div>
                
                <h4 className="text-lg font-serif text-sealiah-eucalyptus mb-3 mt-6">Autres formations</h4>
                <div className="space-y-3">
                  <div>
                    <p className="font-semibold">2020</p>
                    <p>Prise en charge des lésions musculaires du sportif - INFMP</p>
                  </div>
                  <div>
                    <p className="font-semibold">2018</p>
                    <p>Massage ayurvedique - Rasovai méditation et massage training school - Inde</p>
                  </div>
                  <div>
                    <p className="font-semibold">2018</p>
                    <p>Massage thailandais traditionnel - Wat po school - Thaïlande</p>
                  </div>
                  <div>
                    <p className="font-semibold">2017</p>
                    <p>Massage Tuina et cupping (ventouse thérapie) - Université de médecine chinoise de Pékin</p>
                  </div>
                  <div>
                    <p className="font-semibold">2017</p>
                    <p>Massage Balinais - Jamu spa school - Bali</p>
                  </div>
                  <div>
                    <p className="font-semibold">2016</p>
                    <p>Traitement des cicatrices - Formatkine - Paris</p>
                  </div>
                  <div>
                    <p className="font-semibold">2016</p>
                    <p>Kinésithérapie respiratoire du nourrisson et de l'enfant de 0 à 2 ans - Kiné pédiatrie - Paris</p>
                  </div>
                </div>
              </div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      {articles.map((article, index) => (
        {/* Présentation de Maison Sealiah - Déplacée après l'équipe */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
